...
from accounts.views import dashboard_view, user_login, user_registration, SignUpView, edit_user, EditUserView
...
urlpatterns = [
    ...
    path('signup/', user_registration, name='user_register'),
